...
class robotController():
    def __init__(self) -> None:
        ...
        fitting_value = np.array([[-0.398614, 3.26625, -9.77081, -0.975938],
                                    [0.00950963, 0.100817,  -0.902521, 0.0235188],
                                    [-0.0606717, 0.394533, -0.87162, -1.00112],
                                    [ -0.0471849, 0.3302, -0.823095, -1.06686],
                                    [ -0.1984, 1.61775, -4.73458, 7.06878],
                                    [ -0.0130833, 0.116117, -0.366397, 0.795828],
                                    [0.43524, -2.36518, 3.56506, 4.26453],
                                    [0.0379228, -0.172242, 0.0718463, 0.38192],
                                    [-0.0682015, 0.630248, -2.02056, 2.49002],
                                    [-0.072694, 0.648238, -2.03252, 2.38406],
                                    [0.543337, -3.66404, 8.53192, 4.47164],
                                    [0.0544139, -0.383369, 0.946252, 0.204014]])
    ...
    def adva_controller(self):
        ...
        while self.adva_running_flag==True and self.running_flag==False:
            ...
            # soft constrain
            motor_command_left = max(-2, min( U_wl, 2))
            motor_command_right = max(-2, min( U_wr, 2))
